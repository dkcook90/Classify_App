...
function School() {
	const { loading, data } = useQuery(QUERY_ALLSCHOOLS);
						...
						<Card key={school.id} style={{ width: "18rem" }}>
							...
							<Card.Body>
								...
								<Card.Text>
									{school.principle} <br />
									{school.budget} <br />
									Text with address or other school info like head Admin Taylor
									Brown and budget of $250000. Need to make these cards
									dynamically by mapping through each item in the array.
								</Card.Text>
								<ListGroup className="list-group-flush">
									...
									<ListGroupItem>
										<Card.Link href="#">Link to school's classrooms</Card.Link>
									</ListGroupItem>
								</ListGroup>
